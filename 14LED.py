...
# Kanalnamen definieren (anpassen nach Bedarf)
channel_names = [
    "415 nm", "445 nm", "480 nm", "515 nm", "555 nm", "590 nm", "630 nm",
    "680 nm", "700 nm", "750 nm", "780 nm", "850 nm", "NIR", "CLEAR"
]
...
for ch in range(14):
    ...
    label = ttk.Label(frame, text=f"Kanal {ch} ({channel_names[ch]})", width=20)
